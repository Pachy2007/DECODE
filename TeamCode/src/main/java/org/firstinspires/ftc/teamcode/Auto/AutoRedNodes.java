...
public class AutoRedNodes {
    ...
    public static Pose2D[] beforeIntakePosition = {
            new Pose2D(-1370 ,0 , -Math.PI/2) ,
            new Pose2D(-1975 ,0 , -Math.PI/2) ,
            new Pose2D(-2595 ,0 , -Math.PI/2)
    };

    public static Pose2D[] intakePosition = {
            new Pose2D(-1370 ,-1000 , -Math.PI/2) ,
            new Pose2D(-1975 ,-1250 , -Math.PI/2) ,
            new Pose2D(-2595 ,-1250 , -Math.PI/2) ,

    };

    public static Pose2D[] openGatePosition={
            new Pose2D(-1500 , -1000 , -Math.PI)
    };

    public static Pose2D parkPosition=new Pose2D(-1700 , 0 , -Math.PI/2);

    public static double targetX=-30 , targetY=-1170;
